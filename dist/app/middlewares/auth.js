...
const auth = (...roles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        verfiedToken = jwtHelpers_1.jwtHelpers.verifyToken(token, config_1.default.jwt.secret);
        req.user = verfiedToken;
        if (roles.length && !roles.includes(verfiedToken.role)) {
            throw new ApiErrors_1.default(http_status_1.default.FORBIDDEN, "Fobidden");
        }
        next();
    }
    catch (error) {
